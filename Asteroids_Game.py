...
class Asteroids_Game:
    ...
    def _process_game_logic(self):
        ...
        for bullet in self.bullets[:]: #asteroid breaking from bullet hits logic
            for asteroid in self.asteroids[:]:
        ...
        for bullet in self.bullets[:]: #otherwise array would populate with bullets indefinitely, this deletes them
